...
extension AppEvent {
  ...
  public static func rated<T: UnsignedInteger>(_ contentType: String? = nil,
    ...
    contentType.onSome({ parameters[.contentType] = $0 })
    contentId.onSome({ parameters[.contentId] = $0 })
    maxRatingValue.onSome({ parameters[.maxRatingValue] = NSNumber(value: UInt64($0) as UInt64) })
...
extension AppEvent {
  ...
  public static func initiatedCheckout<T: UnsignedInteger>(_ contentType: String? = nil,
    ...
    contentType.onSome({ parameters[.contentType] = $0 })
    contentId.onSome({ parameters[.contentId] = $0 })
    itemCount.onSome({ parameters[.itemCount] = NSNumber(value: UInt64($0) as UInt64) })
